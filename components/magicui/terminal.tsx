...
// Hook for custom terminal steps to integrate with the sequence.
// Returns whether the current item is active and a complete() function
// that advances the sequence to the next item.
export const useTerminalSequenceItem = () => {
  const sequence = useSequence();
  const itemIndex = useItemIndex();
